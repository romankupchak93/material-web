...
let TestFilledField = class TestFilledField extends FilledField {
        ...
        describe('.strokeTransformOrigin', () => {
            it('should be set to eventClientX - rootClientX on click', async () => {
                ...
                expect(instance.strokeTransformOriginProp)
                    .withContext(`should be event.clientX (${clientX}) - root.clientX (${rootRect.x})`)
...
//# sourceMappingURL=filled-field_test.js.map