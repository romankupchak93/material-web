...
let TestTextField = class TestTextField extends TextField {
    constructor() {
        super(...arguments);
...
describe('TextField', () => {
    ...
    describe('focusing the input', () => {
        ...
        it('should call focus() when elements inside text field are clicked', async () => {
            const { harness } = await setupTest();
            spyOn(harness.element, 'focus').and.callThrough();
    ...
    describe('default value', () => {
        ...
        it('should render `value` instead of `defaultValue` when `value` changes', async () => {
            const { harness, input } = await setupTest();
            harness.element.defaultValue = 'Default';
            await env.waitForStability();
    ...
    describe('native validation', () => {
        ...
        it('should expose input validationMessage', async () => {
            const { testElement, input } = await setupTest();
            const spy = spyOnProperty(input, 'validationMessage', 'get').and.callThrough();
        ...
        describe('reportValidity()', () => {
            ...
            it('should not update error or supporting text if invalid event is canceled', async () => {
                const { testElement } = await setupTest();
...
//# sourceMappingURL=text-field_test.js.map